    ...
    <div className="my-container rounded-xl mb-12 ">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-8 ">
        <div className="">
          <img
            src={puzzle}
            className="w-[60%] mx-auto lg:w-[90%] rounded-3xl"
            alt=""
          />
        </div>
        <div className="border-2 border-accent w-full lg:w-[70%] py-12 lg:py-16 px-6 lg:px-14 rounded-3xl">
          <Link>
            <div className="flex items-center gap-4 cursor-pointer ">
              <img src={logo} alt="" className=" w-[30px] lg:w-[35px]" />
            </div>
          </Link>
          <h2 className="text-4xl rehn-bold my-6">Welcome Back!</h2>
          <form onSubmit={handleSubmit} action="">
            ...
            <div className="mb-[0.125rem]  min-h-[1.5rem] pl-[1.5rem] w-[90%] flex justify-between ">
              ...
              <div>
                <button
                  className="text-base underline text-accent inline-block "
            ...
            <p className="text-lg mt-3 rehn-medium text-red-700"> {error}</p>
            <p className="text-lg rehn-medium text-green-700"> {success}</p>
            <input
              type="submit"
          ...
          <p className="text-para mt-4">
            Are you new here?{" "}
            <Link to="/register" className="text-lg underline text-accent2">
              Register
            </Link>
          </p>
          <button
